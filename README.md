...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-11 02:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/76a424b2-6639-487f-a595-ca1b51056a0f.git
$ cd 76a424b2-6639-487f-a595-ca1b51056a0f
```
